...
class EventManager {
  ...
  public function addDemoEvents():Void {
    ...
    e.addOutcome(new Outcome("-20 wealthy donors; -8 student happiness", "Make shoes mandatory"));
    ...
    e.addOutcome(new Outcome("+10 student happiness; +15 wealthy donors; -1mil endowment", "Yes"));
